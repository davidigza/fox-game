...
},{}],"gameSate.js":[function(require,module,exports) {
"use strict";
...
exports.default = iniButtons;

var _constants = require("./constants");

const toggleHighligthted = (icon, show) => document.querySelector(`.${_constants.ICONS[icon]}-icon`).classList.toggle("highlighted", show);

function iniButtons(handleUserAction) {
  let selectedIcon = 0;
  ...
  function buttonClick({
    ...
    if (target.classList.contains("left-btn")) {
      toggleHighligthted(selectedIcon, false);
      selectedIcon = (2 + selectedIcon) % _constants.ICONS.length;
      toggleHighligthted(selectedIcon, true);
...
var _gameSate = _interopRequireWildcard(require("./gameSate"));
...
const init = async () => {
  (0, _buttons.default)(_gameSate.handleUserAction);
  ...
  function nextAnimationFrame() {
    ...
    if (nexTimeToTick <= now) {
      _gameSate.default.tick();

      nexTimeToTick = now + _constants.TICK_RATE;
    }
...
init();
},{"./gameSate":"gameSate.js","./constants":"constants.js","./buttons":"buttons.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
